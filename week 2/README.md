...
```
cd existing_repo
git remote add origin https://git.fim.uni-passau.de/abunafiseh/mining-software-repo-week-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fim.uni-passau.de/abunafiseh/mining-software-repo-week-2/-/settings/integrations)
